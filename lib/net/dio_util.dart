...
import 'package:lighthouse_admin/net/base/base_entity.dart';
import 'package:lighthouse_admin/net/http_error.dart';
import 'package:lighthouse_admin/net/intercept.dart';
...
class DioUtil {
  ...
  Future<BaseEntity<T>> _request<T>(String url, String method, {
    ...
    try {
      ...
      /// 主要目的减少不必要的性能开销
      final bool isCompute = !kDebugMode && jsonString.length > 10 * 1024;
